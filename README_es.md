...
Ejecuta la biblioteca directamente desde GitHub:

```bash
npx github:flatkey-ai/awesome-images
```

La CLI inicia una galería local de prompts y abre el navegador automáticamente. No requiere configuración de proyecto.
...
1. Ejecutar `npx github:flatkey-ai/awesome-images` para abrir la biblioteca.

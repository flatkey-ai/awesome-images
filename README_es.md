...
La CLI lee `FLATKEY_IMAGE_API_KEY` o `FLATKEY_API_KEY`, llama a la API de imágenes de Flatkey y guarda las imágenes localmente. No inicia una web por defecto.

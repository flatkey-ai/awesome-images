...
Run the prompt library directly from GitHub:

```bash
npx github:flatkey-ai/awesome-images
```

The CLI starts a local prompt gallery and opens your browser automatically. No project setup required.
...
1. Run `npx github:flatkey-ai/awesome-images` to open the prompt library.

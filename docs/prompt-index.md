...
- [统一风格头像组](../src/prompts.js) — portrait · gpt-image-2
- [创始人金句卡](../src/prompts.js) — social · gpt-image-2
- [UGC 广告封面帧](../src/prompts.js) — social · gpt-image-2
- [YouTube 封面缩略图](../src/prompts.js) — social · gpt-image-2

## 电商与零售

- [白底电商主图升级](../src/prompts.js) — ecommerce · gpt-image-2
- [保留主体换背景](../src/prompts.js) — edit · gpt-image-2

## 教育与培训

- [液态玻璃 Bento 信息图](../src/prompts.js) — infographic · gpt-image-2

## 时尚与服饰

- [服装 Lookbook 拼贴](../src/prompts.js) — ecommerce · gpt-image-2

## 游戏

- [游戏道具设定图](../src/prompts.js) — game · gpt-image-2

## 营销与广告

- [活动海报主KV](../src/prompts.js) — product · gpt-image-2
- [高端产品海报主视觉](../src/prompts.js) — product · gpt-image-2
...
- [SaaS Hero Phone](../assets/saas-hero-phone.png) — 软件与 SaaS
- [Skincare Product](../assets/ecommerce-skincare.png) — 电商与零售
- [UGC Coffee Ad](../assets/ugc-coffee-ad.png) — 创作者与社交
- [Fitness App](../assets/fitness-app.png) — 运动与健身
- [AI Agent Poster](../assets/ai-agent-poster.png) — 营销与广告
- [Liquid Bento](../assets/liquid-bento.png) — 教育与培训
- [Streetwear Lookbook](../assets/streetwear-lookbook.png) — 时尚与服饰
- [Crystal Game Prop](../assets/game-prop-crystal.png) — 游戏
- [Dessert Hero](../assets/food-dessert.png) — 食品与饮料
- [Travel Map](../assets/travel-map.png) — 旅游与酒店
- [Cyber Portrait](../assets/cyber-portrait.png) — 创作者与社交
- [Interior Render](../assets/real-estate-interior.png) — 房地产与建筑
- [Music Cover](../assets/music-cover.png) — 媒体与娱乐
- [Education Card](../assets/education-card.png) — 教育与培训
- [Finance Dashboard](../assets/finance-dashboard.png) — 金融
- [Beauty Makeup](../assets/beauty-makeup.png) — 美妆与健康
- [Architecture Model](../assets/architecture-model.png) — 房地产与建筑

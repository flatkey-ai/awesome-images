...
Execute a biblioteca diretamente pelo GitHub:

```bash
npx github:flatkey-ai/awesome-images
```

A CLI inicia uma galeria local de prompts e abre o navegador automaticamente. Nenhuma configuração de projeto é necessária.
...
1. Executar `npx github:flatkey-ai/awesome-images` para abrir a biblioteca de prompts.
